class Property < ApplicationRecord
  ...
  validates :postal_code, presence: true, length: { minimum: 6, maximum: 6 },  numericality: { only_integer: true }
  ...
  validates :size, presence: true, length: { maximum: 8 }, numericality: { only_integer: true }
